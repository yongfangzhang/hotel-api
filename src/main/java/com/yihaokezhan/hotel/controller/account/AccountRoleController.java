...
public class AccountRoleController {
    ...
    @SysLog(operation = Operation.RETRIEVE, description = "分页查看账号角色列表 %s", params = "#params")
    ...
    @JsonView(V.S.class)
    @RequiresPermissions(Constant.PERM_ACCOUNT_ROLE_GET)
    @SysLog(operation = Operation.RETRIEVE, description = "查看账号角色列表 %s", params = "#params")
    ...
    @JsonView(V.S.class)
    @RequiresPermissions(Constant.PERM_ACCOUNT_ROLE_GET)
    @SysLog(operation = Operation.RETRIEVE, description = "查看账号角色 %s", params = "#params")
    ...
    @JsonView(V.S.class)
    @RequiresPermissions(Constant.PERM_ACCOUNT_ROLE_GET)
    @SysLog(operation = Operation.RETRIEVE, description = "查看账号角色详情 %s", params = "#uuid")
